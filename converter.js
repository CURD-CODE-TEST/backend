...
// JSON对象的key值转换为驼峰式
var jsonToHump = function jsonToHump(obj) {
...
// JSON对象的key值转换为下划线格式
var jsonToUnderline = function jsonToUnderline(obj) {
    if (obj instanceof Array) {
        obj.forEach(function (v, i) {
            jsonToUnderline(v)
        })
...
module.exports.jsonToHump = jsonToHump;
module.exports.jsonToUnderline = jsonToUnderline;